...
export const ReportsTraceabilityView: React.FC = () => {
    // Entities and Scope State
        ...
        <div className="space-y-6">
            ...
            <div className="border-b border-slate-200 dark:border-slate-800 flex items-center gap-6 text-xs font-semibold">
                ...
                >
                    ...
                    <span>Scope Net Worth & Ownership</span>
                </button>
                <button
                                            ...
                                            <tr key={entry.posting_id} className="hover:bg-slate-50 dark:hover:bg-slate-800/40">
                                                ...
                                                <td className="px-3 py-2.5 text-center whitespace-nowrap">
                                                    {entry.evidence_refs && entry.evidence_refs.length > 0 ? (
                                                        <button
                                                            onClick={() => setSelectedEvidence(entry.evidence_refs[0])}
                                ...
                                {selectedEvidence.bounding_box && (
                                    <div>
                                        ...
                                        <span className="font-mono text-[11px] text-slate-600 dark:text-slate-400">
                                            {JSON.stringify(selectedEvidence.bounding_box)}
                                        </span>
                                    </div>
                                )}
                            </div>
                            <p className="text-[11px] text-slate-500">
                                This metadata links the transaction ledger directly to the verified source document snippet.
                            </p>
                        </div>
