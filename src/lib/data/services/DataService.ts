...
export const COMMON_FIELD_MAPPINGS: FieldMapping[] = [
    ...
    { camelCase: 'targetAmount', snakeCase: 'target_amount' },
    { camelCase: 'currentAmount', snakeCase: 'current_amount' },
    { camelCase: 'startAmount', snakeCase: 'start_amount' },
    { camelCase: 'startDate', snakeCase: 'start_date' },
    { camelCase: 'endDate', snakeCase: 'end_date' },
    { camelCase: 'isActive', snakeCase: 'is_active' },
