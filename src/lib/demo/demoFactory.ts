import { Asset, Liability, RecurringTransaction, AssetType, LiabilityType, CurrencyCode, InvestmentDetails } from '@/types';
...
export function generateDemoProfile(cfg: ProfileConfig): GeneratedProfile {
    ...
    const goals = (cfg.goals || []).map((g, i) => ({
        ...
        startAmount: g.current * 0.5, // Assume started halfway
        category: g.category,
