...
import { Goal, GoalCategory } from '@/features/goals/types';
import { CashFlowEntry, RecurringTransaction } from '@/features/cashflow/types';
import { CurrencyCode, NetWorthSnapshot } from '@/types';
...
export const SAMPLE_ASSETS: Asset[] = [
    ...
    },
    {
        ...
        value: 25100,
        currency: 'USD',
        is_liquid: true, // Fixed: Added missing prop
        interest_rate: 0.1,
        last_updated: new Date().toISOString(),
        investment_details: {
            ticker: "VTI",
...
export const SAMPLE_GOALS: Goal[] = [
    {
        ...
        current_amount: 0, // Auto-calculated in UI usually, but good to init
    ...
    },
    {
        ...
        name: 'Emergency Fund',
        target_amount: 50000,
        current_amount: 32000, // Matches High Yield Savings
    ...
    },
    {
        ...
        target_amount: 0,
        current_amount: 1800,
        start_amount: 2500, // Started with 2.5k debt
    ...
    },
    {
        ...
        start_amount: 360000, // Started with 360k
        category: 'debt_payoff' as GoalCategory,
        deadline: '2032-06-01',
        created_at: new Date().toISOString()
    }
