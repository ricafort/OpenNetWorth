...
import { PayoffScheduleEntry } from '@/features/liabilities/types';
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm h-[300px]">
            ...
            <div className="w-full flex items-center justify-center">
                <AreaChart width={700} height={230} data={data} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
                    ...
                    />
                    <Tooltip
                        formatter={(value: number | string | undefined) => [formatCurrency(Number(value || 0), baseCurrency), 'Remaining Debt']}
