...
"[project]/src/app/api/documents/proposals/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (!documentId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Missing required query parameter: document_id'
            }, {
                status: 400
            });
        }
        const proposals = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$domain$2f$document$2f$documentInboxService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDocumentProposals"])(db, documentId);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            proposals
        });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: err.message || 'Failed to get proposals.'
        }, {
            status: 500
        });
    }
...
async function POST(request) {
    try {
        ...
        if (!Array.isArray(items) || items.length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Items array must contain at least one proposal to approve.'
            }, {
                status: 400
            });
        }
        ...
        const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$domain$2f$document$2f$documentInboxService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["approveProposals"])(db, input);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            ...result
        });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: err.message || 'Failed to approve proposals.'
        }, {
            status: 400
        });
    }
...
async function PATCH(request) {
    try {
        ...
        const updated = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$domain$2f$document$2f$documentInboxService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateProposalReview"])(db, {
            proposal_id,
            event_date,
            counterparty,
            description,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7e962aba._.js.map