...
"[project]/src/app/api/documents/mappings/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const mappings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$domain$2f$document$2f$documentInboxService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listCsvMappings"])(db);
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: err.message || 'Failed to list mappings.'
        }, {
            status: 500
        });
    }
...
async function POST(request) {
    try {
        ...
        const { id, name, header_signature, date_column, date_format, description_column, amount_mode, amount_column, debit_column, credit_column } = body;
        if (!name || !header_signature || !date_column || !description_column || !amount_mode) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Missing required mapping profile fields.'
            }, {
                status: 400
            });
        }
        const saved = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$domain$2f$document$2f$documentInboxService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveCsvMapping"])(db, {
            id,
            name,
            header_signature,
            date_column,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__78f067fa._.js.map