module.exports = [
"[project]/src/lib/domain/accounting/types.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/domain/document/csvParserService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function parseCsvAmount(amountStr, currency = 'USD') {
    ...
    if (!(curr in __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$domain$2f$accounting$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CURRENCY_DECIMALS"])) {
        return {
            amount_cents: null,
            error: `Unsupported currency code: "${currency}". Supported currencies are: ${Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$domain$2f$accounting$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CURRENCY_DECIMALS"]).join(', ')}.`
        };
    }
    const decimals = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$domain$2f$accounting$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CURRENCY_DECIMALS"][curr];
    const factor = Math.pow(10, decimals);
    ...
    try {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$domain$2f$accounting$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["assertValidMoneyCents"])(cents, `Parsed CSV amount for "${amountStr}"`);
    } catch (err) {
        return {
            amount_cents: null,
            error: err.message
...
//# sourceMappingURL=src_lib_domain_611ee71e._.js.map