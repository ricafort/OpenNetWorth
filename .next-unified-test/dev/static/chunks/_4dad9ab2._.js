...
"[project]/src/features/mentors/components/WisdomBanner.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const standardQuotes = [
    {
        text: "Consistency compounds as much as capital does.",
        author: "Long-Term Thinker",
        mentorId: "lt"
    },
    {
        text: "Capital preservation is the first rule of wealth building.",
        author: "Risk Guardian",
        mentorId: "rg"
    },
    {
        text: "Look for underutilized resources and creative expansion.",
        author: "Growth Optimist",
        mentorId: "go"
    },
    {
        text: "Find freedom in simplicity and detachment from comparison.",
        author: "Stoic Minimalist",
        mentorId: "sm"
    }
];
function WisdomBanner({ customMentors = [], onOpenSettings }) {
    _s();
    const [allQuotes, setAllQuotes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(standardQuotes);
    const [filteredQuotes, setFilteredQuotes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(standardQuotes);
    ...
    const [rotationSpeed, setRotationSpeed] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(15); // Default 15s
    ...
    const [filterMentorId, setFilterMentorId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    // Load quotes and settings
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WisdomBanner.useEffect": ()=>{
            ...
            const customQuotes = [];
            customMentors.forEach({
                "WisdomBanner.useEffect": (m)=>{
                    if (m.quotes && Array.isArray(m.quotes)) {
                        m.quotes.forEach({
                            "WisdomBanner.useEffect": (q)=>{
                                customQuotes.push({
                                    text: q,
                                    author: m.name,
                                    mentorId: m.id
        ...
        "WisdomBanner.useEffect": ()=>{
            if (filterMentorId) {
                const filtered = allQuotes.filter({
                    "WisdomBanner.useEffect.filtered": (q)=>q.mentorId === filterMentorId
                }["WisdomBanner.useEffect.filtered"]);
    ...
    const nextQuote = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "WisdomBanner.useCallback[nextQuote]": ()=>{
            if (filteredQuotes.length === 0) return;
            setCurrentIndex({
                "WisdomBanner.useCallback[nextQuote]": (prev)=>(prev + 1) % filteredQuotes.length
            }["WisdomBanner.useCallback[nextQuote]"]);
        }
    }["WisdomBanner.useCallback[nextQuote]"], [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WisdomBanner.useEffect": ()=>{
            ...
            return ({
                "WisdomBanner.useEffect": ()=>clearInterval(interval)
            })["WisdomBanner.useEffect"];
        }
    }["WisdomBanner.useEffect"], [
        isPlaying,
    ...
    const handleBookmark = ()=>{
        ...
        const exists = saved.find((q)=>q.text === currentQuote.text);
        if (exists) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WisdomBanner.useEffect": ()=>{
            const saved = JSON.parse(localStorage.getItem('saved_quotes') || '[]');
            const currentQuote = filteredQuotes[currentIndex];
            setIsBookmarked(!!saved.find({
                "WisdomBanner.useEffect": (q)=>q.text === currentQuote?.text
            }["WisdomBanner.useEffect"]));
        }
    }["WisdomBanner.useEffect"], [
        currentIndex,
    ...
    const mentors = Array.from(new Map(allQuotes.map((q)=>[
            q.mentorId,
            {
                id: q.mentorId,
                name: q.author,
                initial: q.author.charAt(0)
            }
        ])).values());
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "relative group bg-card rounded-3xl border border-border shadow-sm overflow-hidden transition-all hover:shadow-md",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "relative p-8 md:p-12 flex flex-col items-center justify-center text-center h-[280px]",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$settings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Settings$3e$__["Settings"], {
                                ...
                                fileName: "[project]/src/features/mentors/components/WisdomBanner.tsx",
                                lineNumber: 128,
                                columnNumber: 25
                            }, this)
                        }, void 0, false, {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "max-w-3xl animate-in fade-in slide-in-from-bottom-2 duration-500 w-full flex flex-col items-center",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: `font-serif text-muted-foreground italic leading-relaxed mb-6 transition-all duration-300 ${currentQuote?.text.length > 150 ? 'text-lg md:text-xl' : currentQuote?.text.length > 80 ? 'text-xl md:text-2xl' : 'text-2xl md:text-3xl'}`,
                                children: [
                                    '"',
                                    currentQuote?.text,
                                    '"'
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "h-px w-8 bg-blue-100"
                                    }, void 0, false, {
                                        fileName: "[project]/src/features/mentors/components/WisdomBanner.tsx",
                                        lineNumber: 140,
                                        columnNumber: 25
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "text-xs font-black text-blue-600 uppercase tracking-widest whitespace-nowrap",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "bg-muted/80 backdrop-blur-sm border-t border-border py-3 px-6 flex items-center justify-between gap-4",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex -space-x-1.5 overflow-x-auto no-scrollbar py-1 px-1 mask-linear-fade",
                        children: mentors.map((m)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                onClick: ()=>setFilterMentorId(filterMentorId === m.id ? null : m.id),
                                className: `shrink-0 h-8 w-8 rounded-full border flex items-center justify-center text-[10px] font-black transition-all ring-2 ring-slate-50 hover:z-10 hover:scale-110 active:scale-90 ${filterMentorId === m.id ? 'bg-blue-600 border-blue-600 text-white shadow-md z-10' : 'bg-card border-border text-muted-foreground'}`,
                                title: m.name,
                                children: m.initial
                            }, m.id, false, {
                                fileName: "[project]/src/features/mentors/components/WisdomBanner.tsx",
...
_s(WisdomBanner, "KRbyyFcPF73SgdoUtNUJ4DRMDhw=");
_c = WisdomBanner;
var _c;
__turbopack_context__.k.register(_c, "WisdomBanner");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/features/mentors/widgets/WisdomWidget.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$mentors$2f$components$2f$WisdomBanner$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/mentors/components/WisdomBanner.tsx [app-client] (ecmascript)");
...
function WisdomWidget() {
    _s();
    const { isEditMode, hideWidget, openSettings } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$context$2f$DashboardContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDashboard"])();
    const [customMentors, setCustomMentors] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WisdomWidget.useEffect": ()=>{
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$shield$2d$check$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ShieldCheck$3e$__["ShieldCheck"], {
                            ...
                            fileName: "[project]/src/features/mentors/widgets/WisdomWidget.tsx",
                            lineNumber: 29,
                            columnNumber: 21
                        }, this),
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                            className: "text-lg font-black text-foreground uppercase tracking-tighter",
                            children: "Wisdom Board"
                        }, void 0, false, {
                            fileName: "[project]/src/features/mentors/widgets/WisdomWidget.tsx",
                            lineNumber: 30,
                            columnNumber: 21
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$mentors$2f$components$2f$WisdomBanner$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
_s(WisdomWidget, "IMC0V+im8M/sANDGC+Swqw7hoi8=", false, function() {
    return [
...
_c = WisdomWidget;
var _c;
__turbopack_context__.k.register(_c, "WisdomWidget");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_4dad9ab2._.js.map